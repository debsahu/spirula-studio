...
| [notes/flare.md](notes/flare.md) | removing the sun's lens ghosts from fisheye frames: where it runs, what it can and cannot remove, and the OpenOSV attribution |
