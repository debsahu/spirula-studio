...
row src/app/gui/mask/MaskSession.cpp 650-661 "MaskSession::commit_stroke" 650
row src/app/gui/mask/MaskSession.cpp 650-661 "if (r.empty()) return {};" 661
...
row src/app/gui/mask/MaskSession.cpp 265 "enqueue([this, f, i]"
row src/app/gui/mask/MaskSession.cpp 285 "_status.clear();"
row src/app/gui/mask/MaskSession.cpp 337 "_livewire.reset();"
...
row src/app/gui/mask/MaskSession.cpp 668-693 "// Plain and Shift drop, Ctrl keeps" 668
row src/app/gui/mask/MaskSession.cpp 668-693 "const bool keep = ctrl != erasing;"
row src/app/gui/mask/MaskSession.cpp 668-693 "if (!(r > kMinBrush)) return kMinBrush;"
row src/app/gui/mask/MaskSession.cpp 668-693 "std::pow(1.18f, wheel)"
row src/app/gui/mask/MaskSession.cpp 668-693 "}" 693
row src/app/gui/mask/MaskSession.h 159-160 "float radius() const { return _brush; }"
row src/app/gui/mask/MaskSession.h 159-160 "set_radius(float r) { _brush = clamp_brush(r); }"
...
row src/app/gui/mask/MaskSession.h 403 "std::shared_ptr<const std::vector<uint8_t>> _rgb;"
...
row src/app/gui/mask/MaskSession.cpp 314 "_doc_gen++;"
